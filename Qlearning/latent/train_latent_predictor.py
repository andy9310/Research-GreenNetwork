...
def train_agent(args):
    ...
    if prediction_errors:
        ...
        plt.title('State Predictor Errors')
        errors_plot_path = f"models/latent_predictor_errors_{config_name}.png"
        plt.savefig(errors_plot_path)
        print(f"Prediction errors plot saved to {errors_plot_path}")
...
def main():
    ...
    parser.add_argument('--latent-dim', type=int, default=16, help='Dimension of latent state representation')
    ...
    # Training parameters
    parser.add_argument('--episodes', type=int, default=3000, help='Number of episodes per traffic matrix')
    parser.add_argument('--tm-rounds', type=int, default=5, help='Number of rounds to cycle through all traffic matrices')
    parser.add_argument('--lr', type=float, default=1e-2, help='Learning rate for DQN')
